...
impl Renderer {
    pub fn new(
        ...
        // bound whether or not anything samples it in a given frame.
        //
    ...
    fn record(&self, slot: usize, image_index: usize, list: &DrawList) -> Result<()> {
        ...
        unsafe {
            ...
            // Six floats: the pixel to clip conversion factor, then the palette
            // mapping. Set once per frame because one surface uses it.
            let push: [f32; 6] = [
                extent.width as f32,
